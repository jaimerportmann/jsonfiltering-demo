            ...
            //console.log(json); // this will show the info it in firebug console
              ...
              $.each( data, function( key, val ) {
                ...
                if (jQuery.inArray(type, val.discipline) !='-1') {
                    items.push( '<div class="coach"><div class="self"><div class="self-avatar"><img src="' + val.picture + '"/></div><div class="self-data"><div style="font-size:18px">' + val.name + '</div><div style="font-size:10px">' + val.discipline + '</div></div></div><div class="value"><img src="assets/price.png"/> 25$ <img src="assets/time.png"/> 0:45</div><div class="view-details" onclick="$(this).children().show();">View Details<br><div class="details">' + val.about + ' <div class="contact">contact now!</div></div></div>' );
